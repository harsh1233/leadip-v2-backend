...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::table('list_contacts', function (Blueprint $table) {
            DB::statement("ALTER TABLE `list_contacts` CHANGE `type` `type` ENUM('P','CL','C','LC') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'P:Prospect, CL:Custom List, C:Client, LC:Lost Contacts'");
        });
    }
